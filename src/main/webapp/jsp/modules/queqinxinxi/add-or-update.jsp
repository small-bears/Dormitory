		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑缺勤信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>缺勤信息管理</span></li>
								<li class="breadcrumb-item active"><span>编辑缺勤信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">缺勤信息信息</h3>
								...
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										...
										<select id="leixingSelect" name="leixing" class="form-control">
												<option value=""></option>
												<option class="leixingOption" value="请假">
													请假
												</option>
												<option class="leixingOption" value="未归宿">
													未归宿
												</option>
										</select>	
									</div>	
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "queqinxinxi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("queqinxinxi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("queqinxinxi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("queqinxinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
