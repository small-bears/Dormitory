...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">宿舍分配管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>宿舍分配列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">宿舍分配列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="chuangweihaoSearch" class="form-control form-control-sm" placeholder="请输入床位号" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('chuangweihao')">床位号<i id="chuangweihaoIcon" class="fa fa-sort"></i></th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody>
	...
	<script>
		...
		function search(){
			...
			if($('#chuangweihaoSearch').val() != null && $('#chuangweihaoSearch').val() != ''){
				searchForm.chuangweihao ="%" +  $('#chuangweihaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("sushefenpei/page","GET",{
				...
				chuangweihao : searchForm.chuangweihao,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var chuangweihaoCell  = document.createElement('td');

						 chuangweihaoCell.innerHTML = item.chuangweihao;

			row.appendChild(chuangweihaoCell);
	...
	function printTable() {
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("sushefenpei/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"sushefenpei");
