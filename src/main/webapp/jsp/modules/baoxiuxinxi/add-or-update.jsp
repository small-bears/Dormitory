		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑报修信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>报修信息管理</span></li>
								<li class="breadcrumb-item active"><span>编辑报修信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">报修信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>设备名称</label>
										<input name="shebeimingcheng" id="shebeimingcheng" name="shebeimingcheng" class="form-control" placeholder="设备名称">
									</div>
									<div class="form-group col-md-6">
										<label>学号</label>
									...
									<div class="form-group col-md-6">
										<label>报修时间</label>
										<div id="baoxiushijianDate" class="input-append date form_datetime">
											<input id="baoxiushijian-input" name="baoxiushijian" size="20" type="text" readonly>
											...
											<div class="form-group  col-md-12" >
												<label>情况说明</label>
												<div><div class="upload"><input id="qingkuangshuomingupload" name="file" type="file">选择文件</div>
												<script id="qingkuangshuomingEditor" type="text/plain"></script>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "baoxiuxinxi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("baoxiuxinxi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("baoxiuxinxi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getContent(){
			if(UE.getEditor('qingkuangshuomingEditor').hasContents()){
				$('#qingkuangshuoming-input').attr('value',UE.getEditor('qingkuangshuomingEditor').getContent());
			}
		}
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("baoxiuxinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#baoxiushijianDate").datetimepicker({ 
				autoclose: true,
		...
		function dataBind(){
			...
			$("#baoxiushijian-input").val(ruleForm.baoxiushijian);
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.shebeimingcheng != null && res.data.shebeimingcheng != ''){
						...
						$("#shebeimingcheng").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.baoxiushijian != null && res.data.baoxiushijian != ''){

						$("#baoxiushijian-input").val(res.data.baoxiushijian);
						$('#baoxiushijianFileName').val(res.data.baoxiushijian)
					}
					if(res.data != null && res.data != '' && res.data.qingkuangshuoming != null && res.data.qingkuangshuoming != ''){
						...
						$("#qingkuangshuoming").attr('readonly','readonly');
					}
