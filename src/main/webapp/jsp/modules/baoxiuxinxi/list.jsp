...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">报修信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>报修信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">报修信息列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										设备名称
									</label>
									<input type="text" id="shebeimingchengSearch" class="form-control form-control-sm" placeholder="请输入设备名称" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('shebeimingcheng')">设备名称<i id="shebeimingchengIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('baoxiushijian')">报修时间<i id="baoxiushijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var baoxiushijianCell  = document.createElement('td');

						  baoxiushijianCell.innerHTML = item.baoxiushijian;


			row.appendChild(baoxiushijianCell);
			var qingkuangshuomingCell  = document.createElement('td');
		...
		function sh(){
			...
			httpJson("baoxiuxinxi/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("baoxiuxinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"baoxiuxinxi");
