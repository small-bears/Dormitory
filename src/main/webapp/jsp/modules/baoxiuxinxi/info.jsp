						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="shebeimingcheng" name="shebeimingcheng" class="form-control" v-model="ruleForm.shebeimingcheng" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>学号</label>
									...
									<input id="baoxiushijian" name="baoxiushijian" class="form-control" v-model="ruleForm.baoxiushijian" readonly>
									</div>
	...
	<script>
		...
		function setContent(){
			if(ruleForm.qingkuangshuoming != null && ruleForm.qingkuangshuoming != 'null' && ruleForm.qingkuangshuoming != ''){
				var mes = '' + ruleForm.qingkuangshuoming;
				var qingkuangshuomingUeditor = UE.getEditor('qingkuangshuomingEditor');
				qingkuangshuomingUeditor.ready(function() {
					qingkuangshuomingUeditor.setContent(mes);
					qingkuangshuomingUeditor.setDisabled('fullscreen');
				});
			}
