...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20210726/fa64b89ec7064f668de587c1b0512b7f.jpg) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">宿管账号</label> 
							<input  name="suguanzhanghao" placeholder="宿管账号" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">宿管姓名</label> 
							<input  name="suguanxingming" placeholder="宿管姓名" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">楼号</label> 
							<input  name="louhao" placeholder="楼号" class="form-control-i">
							</div>
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "susheguanliyuan/register";
				$.ajax({ 
					type: "POST",
					url: url,
