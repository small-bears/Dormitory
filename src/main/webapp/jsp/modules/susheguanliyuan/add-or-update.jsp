		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑宿舍管理员</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑宿舍管理员</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">宿舍管理员信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>宿管账号</label>
										<input name="suguanzhanghao" id="suguanzhanghao" name="suguanzhanghao" class="form-control" placeholder="宿管账号">
									</div>
									<div class="form-group col-md-6">
										<label>宿管姓名</label>
										<input name="suguanxingming" id="suguanxingming" name="suguanxingming" class="form-control" placeholder="宿管姓名">
									</div>
									<div class="form-group col-md-6">
										<label>密码</label>
									...
									<div class="form-group col-md-6">
										<label>楼号</label>
										<input name="louhao" id="louhao" name="louhao" class="form-control" placeholder="楼号">
									</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "susheguanliyuan/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("susheguanliyuan/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("susheguanliyuan/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("susheguanliyuan/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#suguanzhanghao").val(ruleForm.suguanzhanghao);	
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.suguanzhanghao != null && res.data.suguanzhanghao != ''){
						...
						$("#suguanzhanghao").val(res.data.suguanzhanghao);
						$("#suguanzhanghao").attr('readonly','readonly');
					}
