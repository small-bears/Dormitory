...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">宿舍管理员管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>宿舍管理员管理</span></li>
								<li class="breadcrumb-item active"><span>宿舍管理员列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">宿舍管理员列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										宿管账号
									</label>
									<input type="text" id="suguanzhanghaoSearch" class="form-control form-control-sm" placeholder="请输入宿管账号" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('louhao')">楼号<i id="louhaoIcon" class="fa fa-sort"></i></th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#suguanzhanghaoSearch').val() != null && $('#suguanzhanghaoSearch').val() != ''){
				searchForm.suguanzhanghao ="%" +  $('#suguanzhanghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("susheguanliyuan/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				suguanzhanghao : searchForm.suguanzhanghao,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var louhaoCell  = document.createElement('td');

						 louhaoCell.innerHTML = item.louhao;

			row.appendChild(louhaoCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("susheguanliyuan/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function getSum(colName){
		http("susheguanliyuan"+colName,"GET",{
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"susheguanliyuan");
