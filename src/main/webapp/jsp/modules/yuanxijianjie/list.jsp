...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">院系简介管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>院系简介列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">院系简介列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										学院名称
									</label>
									<input type="text" id="xueyuanmingchengSearch" class="form-control form-control-sm" placeholder="请输入学院名称" aria-controls="tableId">
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var yuanxijianjieCell  = document.createElement('td');
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("yuanxijianjie/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"yuanxijianjie");
