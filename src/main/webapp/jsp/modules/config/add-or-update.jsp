...
<body>
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>名称</label>
										<input name="name" id="name" name="name" class="form-control" placeholder="名称">
									</div>
									<div class="form-group col-md-6">
										<label>值</label>
	...
	<script>
		...
		function upload(){
			$('#valueupload').fileupload({
				...
				dataType: 'json',
					...
					document.getElementById('value-input').setAttribute('value',"upload/"+data.result.file);
		...
		function showImg(){
			...
			$("#valueImg").attr("src",baseUrl+ruleForm.value);
		}		
		//跨表
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.value != null && res.data.value != ''){
						...
						$("#valueImg").attr("src",baseUrl+res.data.value);
