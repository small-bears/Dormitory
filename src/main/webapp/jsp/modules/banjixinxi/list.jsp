...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">班级信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>班级信息管理</span></li>
								<li class="breadcrumb-item active"><span>班级信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">班级信息列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="fudaoyuanSearch" class="form-control form-control-sm" placeholder="请输入辅导员" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('banjirenshu')">班级人数<i id="banjirenshuIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('fudaoyuan')">辅导员<i id="fudaoyuanIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			if($('#fudaoyuanSearch').val() != null && $('#fudaoyuanSearch').val() != ''){
				searchForm.fudaoyuan ="%" +  $('#fudaoyuanSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("banjixinxi/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				banji : searchForm.banji,	
				fudaoyuan : searchForm.fudaoyuan,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var banjirenshuCell  = document.createElement('td');

						 banjirenshuCell.innerHTML = item.banjirenshu;

			row.appendChild(banjirenshuCell);
			var fudaoyuanCell  = document.createElement('td');

						 fudaoyuanCell.innerHTML = item.fudaoyuan;

			row.appendChild(fudaoyuanCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("banjixinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"banjixinxi");
